...
{
	[SerializeField][Tooltip("prefabs we're using to spawn the dungeon out of")]
	private GameObject[] _prefabs;
	[SerializeField][Tooltip("the maximum amount of times the prefabs will be spawned")]
	private int _maxRooms = 10;
	[SerializeField][Tooltip("the maximum amount of times the system will try to spawn these rooms")]
